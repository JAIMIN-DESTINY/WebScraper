...
<head>
    ...
    <title>TxParts Scraping Dashboard For Mobile Sentrix</title>
    <style>
        :root {
            --bg: #f6f9fb;
...
<body>
    <main class="page">
        ...
        <section class="metrics" aria-label="Scraping metrics">
            ...
            <a class="metric-card {{ $activeTable === 'price' ? 'is-active' : '' }}" href="{{ route('ms-dashboard', ['table' => 'price']) }}">
                <div class="metric-label">Price Changes</div>
                <div class="metric-value">{{ number_format($metrics['price_changes']) }}</div>
                <div class="metric-sub">Tracked price differences</div>
            </a>

            <a class="metric-card {{ $activeTable === 'description' ? 'is-active' : '' }}" href="{{ route('ms-dashboard', ['table' => 'description']) }}">
                <div class="metric-label">Description Updates</div>
                <div class="metric-value">{{ number_format($metrics['description_updates']) }}</div>
                <div class="metric-sub">Tracked content differences</div>
            </a>
        </section>
            ...
            <aside class="glass-panel">
                ...
                <div class="status-list">
                    ...
                    <div class="status-row">
                        ...
                        <div class="status-value">{{ $status['next_run'] }}</div>
                    </div>
                </div>
            </aside>
        </section>
                            ...
                            <tr data-change-row>
                                @foreach ($dashboardTable['columns'] as $column)
                                    <td class="{{ $column === 'Product' ? 'product-cell' : '' }}">
                                        @if ($column === 'Type')
                                            <span class="type-badge">{{ $row[$column] }}</span>
                                        @elseif ($column === 'URL')
                                            @if ($row[$column])
