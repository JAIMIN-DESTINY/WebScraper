...
<head>
    ...
    <title>TxParts Scraping Dashboard For Parts4Cells</title>
    <style>
        :root {
            --bg: #f6f9fb;
...
<body>
    <main class="page">
        <header class="topbar">
            <h1>TxParts Scraping Dashboard For Parts4Cells</h1>
            <a class="export-btn" href="{{ route('p4c-products.export') }}">Export All Products</a>
        </header>

        @include('partials.dashboard-switcher', ['activeDashboard' => 'p4c'])

        <section class="metrics" aria-label="Scraping metrics">
            <a class="metric-card {{ $activeTable === 'products' ? 'is-active' : '' }}" href="{{ route('p4c-dashboard', ['table' => 'products']) }}">
